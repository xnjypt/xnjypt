...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="wdlevel/list.do" method="post" name="Form" id="Form">
			<table>
				<tr>
					<td>
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<thead>
					<tr>
						...
						<th class="center">提现等级</th>
						<th class="center">人民币提现汇率</th>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>wdlevel/excel.do';
		}
		</script>
